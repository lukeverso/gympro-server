...
CREATE TABLE "Students" (
    ...
    CONSTRAINT "Students_measuresId_fkey" FOREIGN KEY ("measuresId") REFERENCES "Measures" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Measures_studentId_key" ON "Measures"("studentId");
